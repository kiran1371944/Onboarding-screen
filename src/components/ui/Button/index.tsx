...
const buttonVariants = cva(
  'btn inline-flex items-center justify-center text-sm font-medium transition-colors disabled:opacity-50 disabled:pointer-events-none ',
  {
    variants: {
      variant: {
        default:
          'bg-cocogreen-900 dark:bg-slate-50 text-white hover:bg-slate-700 dark:text-slate-900 dark:hover:text-slate-100',
        danger:
          'text-white bg-red-600 hover:bg-red-600 font-medium text-sm px-5 py-2.5 me-2 mb-2 dark:hover:bg-red-700 ',
        success:
          'text-white bg-green-600 hover:bg-green-600 font-medium text-sm px-5 py-2.5 me-2 mb-2 dark:hover:bg-green-700 ',
        warning:
          'text-white bg-yellow-500 hover:bg-yellow-600 font-medium text-sm px-5 py-2.5 me-2 mb-2 dark:hover:bg-yellow-700 ',
        outline:
        ...
        outlineNoHover:
          'bg-transparent bg-transparent py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900  border border-gray-200  hover:text-stale-900 dark:text-gray-900 dark:border-gray-600 dark:hover:border-gray-600 dark:hover:text-gray-900 dark:hover:bg-transparent',
        subtle:
